...
def main():
    plot_accuracy_f1_vs_seq_len("results/experiments_summary.csv", "results/plots/accuracy_f1_vs_seq_length.png")
    plot_training_loss_best_worst("results/experiments_summary.csv", "results/plots/training_loss_best_worst.png")
